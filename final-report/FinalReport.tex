...
\\
\\
Finally, an experimental similarity measure will be implemented which uses the cosine similarity of the definitions.
\\
\\
...
For the second room, the player is presented with a battle with an enemy as part of the \textit{Battle} mode.
