...
\\
\\
To access the WordNet lexical database, the JWI (Java WordNet Interface) will be used because, according the the author Mark Finlayson, it is the "highest-performance, widest-coverage, easiest-to-use library available" \cite{RefWorks:19}. For the POS tagger, 
